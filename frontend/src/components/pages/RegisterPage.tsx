      ...
      <div className="flex-1 flex flex-col justify-between p-8 sm:p-12 md:p-16 lg:p-20 relative overflow-hidden bg-bg-primary">
        ...
        <div className="my-auto max-w-sm w-full mx-auto space-y-8 relative z-10">
          <div className="space-y-2">
            <h2 className="text-3xl font-extrabold tracking-tight text-white m-0">Enroll Node</h2>
            <p className="text-sm text-slate-400">Register new terminal operator credentials</p>
          </div>
          ...
          <AnimatePresence mode="wait">
            {success ? (
              <motion.div
                ...
                exit={{ opacity: 0 }}
                className="py-8 text-center space-y-4 bg-[#12182A]/30 border border-border-custom p-6 rounded-2xl"
              >
                ...
                <div className="space-y-1.5">
                  <h3 className="text-base font-bold text-white">Enrollment Dispatched</h3>
                  <p className="text-xs text-slate-450">
                    Authentication parameters saved. Redirecting to validation gateway...
                  </p>
                </div>
                <div className="h-1.5 w-24 bg-success/10 rounded-full overflow-hidden mx-auto">
                  <div className="h-full bg-success w-1/2 rounded-full animate-bounce" />
                </div>
              </motion.div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {/* Username Input with Peer Floating Label */}
                ...
                <div className="relative">
                  ...
                  <label
                    ...
                    peer-placeholder-shown:top-4.5 peer-placeholder-shown:text-xs peer-placeholder-shown:text-slate-400
                    peer-focus:top-1.5 peer-focus:text-[10px] peer-focus:text-accent
                    peer-[:not(:placeholder-shown)]:top-1.5 peer-[:not(:placeholder-shown)]:text-[10px] peer-[:not(:placeholder-shown)]:text-slate-450"
                  >
                    Operator Email
                  </label>
                </div>

                {/* Password Input with Peer Floating Label */}
                <div className="relative">
                  <div className="absolute left-4 top-[17px] text-slate-400 pointer-events-none">
                ...
                <div className="relative">
                  <div className="absolute left-4 top-[18px] text-slate-455 pointer-events-none">
                  ...
                  <select
                    ...
                    disabled={isLoading}
                    className="w-full bg-[#12182A]/30 border border-border-custom rounded-xl pt-5 pb-2.5 pl-11 pr-10 text-sm text-white focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/20 transition duration-200 appearance-none cursor-pointer"
                  >
                  ...
                  <label className="absolute left-11 top-1 text-[9px] text-slate-500 font-mono uppercase tracking-wider">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full relative overflow-hidden group py-3.5 mt-2 rounded-xl gradient-btn-premium font-bold text-xs tracking-wider uppercase text-[#0A0F1F] cursor-pointer shadow-lg transition-all duration-300 flex items-center justify-center space-x-2"
                >
                  {isLoading ? (
